...
public class InternalSchemeLexer extends Lexer {
    ...
    public final void mT__15() throws RecognitionException {
        try {
            int _type = T__15;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:13:7: ( '(' )
            // InternalScheme.g:13:9: '('
            {
            match('('); 
    ...
    public final void mT__16() throws RecognitionException {
        try {
            int _type = T__16;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:14:7: ( ')' )
            // InternalScheme.g:14:9: ')'
            {
            match(')'); 
    ...
    public final void mRULE_SCHEME_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:405:16: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '-' )* )
            // InternalScheme.g:405:18: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '-' )*
            {
            ...
            // InternalScheme.g:405:38: ( 'a' .. 'z' | 'A' .. 'Z' | '-' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_OPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:407:15: ( ( '+' | '-' | '*' | '/' | 'and' | 'or' ) )
            // InternalScheme.g:407:17: ( '+' | '-' | '*' | '/' | 'and' | 'or' )
            {
            // InternalScheme.g:407:17: ( '+' | '-' | '*' | '/' | 'and' | 'or' )
            int alt2=6;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:409:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalScheme.g:409:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalScheme.g:409:11: ( '^' )?
            int alt3=2;
            ...
            // InternalScheme.g:409:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:411:10: ( ( '0' .. '9' )+ )
            // InternalScheme.g:411:12: ( '0' .. '9' )+
            {
            // InternalScheme.g:411:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:413:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalScheme.g:413:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalScheme.g:413:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalScheme.g:413:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalScheme.g:413:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalScheme.g:413:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalScheme.g:413:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:415:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalScheme.g:415:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalScheme.g:415:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:417:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalScheme.g:417:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalScheme.g:417:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:419:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalScheme.g:419:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalScheme.g:419:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalScheme.g:421:16: ( . )
            // InternalScheme.g:421:18: .
            {
            matchAny(); 
    ...
    static final String DFA14_eotS =
        "\1\uffff\1\21\2\uffff\1\30\3\uffff\1\32\2\30\1\21\2\uffff\2\21\6\uffff\2\30\5\uffff\1\30\3\uffff\1\30";
    static final String DFA14_eofS =
        "\42\uffff";
    static final String DFA14_minS =
        "\1\0\1\146\2\uffff\1\60\3\uffff\1\52\2\60\1\101\2\uffff\2\0\6\uffff\2\60\5\uffff\1\60\3\uffff\1\60";
    static final String DFA14_maxS =
        "\1\uffff\1\164\2\uffff\1\172\3\uffff\1\57\3\172\2\uffff\2\uffff\6\uffff\2\172\5\uffff\1\172\3\uffff\1\172";
    static final String DFA14_acceptS =
        "\2\uffff\1\3\1\4\1\uffff\3\6\4\uffff\1\7\1\10\2\uffff\1\14\1\15\1\1\1\2\1\3\1\4\2\uffff\1\5\1\7\1\6\1\12\1\13\1\uffff\1\10\1\11\1\14\1\uffff";
    static final String DFA14_specialS =
        "\1\1\15\uffff\1\0\1\2\22\uffff}>";
    static final String[] DFA14_transitionS = {
            "\11\21\2\20\2\21\1\20\22\21\1\20\1\21\1\16\1\1\3\21\1\17\1\2\1\3\1\7\1\5\1\21\1\6\1\21\1\10\12\15\7\21\32\12\3\21\1\13\1\14\1\21\1\4\15\12\1\11\13\12\uff85\21",
            "\1\23\15\uffff\1\22",
            "",
            "",
